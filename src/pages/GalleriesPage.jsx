    ...
    <div className="min-h-full">
      <div className="p-4 md:p-6">
        <div className="max-w-7xl mx-auto">
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-4">
              <div className="relative flex-grow">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <svg className={`h-5 w-5 ${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`} viewBox="0 0 20 20" fill="currentColor">
              ...
              <div className="sm:w-64">
                <select
                  ...
                  className={`block w-full border rounded-md py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 ${
                    isDarkMode
          ...
          {/* Loading state */}
          {loading && (
            <div className={`flex justify-center items-center p-12 ${isDarkMode ? 'bg-gray-800' : 'bg-white'} rounded-lg shadow-md`}>
          ...
          {/* Error state */}
          {error && (
            <div className={`${isDarkMode ? 'bg-red-900' : 'bg-red-50'} border-l-4 border-red-500 p-4 rounded-lg`}>
              <div className="flex">
            ...
            <>
              {filteredGalleries.length === 0 ? (
                <div className={`${isDarkMode ? 'bg-gray-800' : 'bg-white'} p-12 text-center rounded-lg shadow-md`}>
                  <svg className={`h-12 w-12 ${isDarkMode ? 'text-gray-500' : 'text-gray-400'} mx-auto`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9.75 9.75l4.5 4.5m0-4.5l-4.5 4.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <h3 className={`mt-2 text-sm font-medium ${isDarkMode ? 'text-gray-200' : 'text-gray-900'}`}>No galleries found</h3>
